...
declare module 'rxjs' {
  ...
  declare export type SchedulerLike = rxjs$SchedulerLike;
  declare export type OperatorFunction<T, R> = rxjs$OperatorFunction<T, R>;
  declare export type MonoTypeOperatorFunction<
    T,
...
declare module 'rxjs/fetch' {
  declare export function fromFetch(
