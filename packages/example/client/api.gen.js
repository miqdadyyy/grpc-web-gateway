...
export const BytesValue = $root.BytesValue = (() => {
    ...
    BytesValue.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.BytesValue();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
...
export const Bytes = $root.Bytes = (() => {
    ...
    Bytes.encode = function encode(message, writer) {
        ...
        if (message.byteString != null && message.hasOwnProperty("byteString"))
            $root.BytesValue.encode(message.byteString, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        return writer;
    };
    ...
    Bytes.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Bytes();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    Bytes.toObject = function toObject(message, options) {
        ...
        if (message.byteString != null && message.hasOwnProperty("byteString"))
            object.byteString = $root.BytesValue.toObject(message.byteString, options);
        return object;
    };
...
export const Long = $root.Long = (() => {
    ...
    Long.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Long();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    Long.fromObject = function fromObject(object) {
        if (object instanceof $root.Long)
            return object;
...
export const Test = $root.Test = (() => {
     ...
     * @variation 1
     */
    Object.defineProperty(Test.prototype.unary = function unary(request, callback) {
     ...
     * @variation 1
     */
    Object.defineProperty(Test.prototype.unaryBytes = function unaryBytes(request, callback) {
        return this.rpcCall(unaryBytes, $root.Bytes, $root.Bytes, request, callback);
    }, "name", { value: "UnaryBytes" });
     ...
     * @variation 1
     */
    Object.defineProperty(Test.prototype.long = function long(request, callback) {
     ...
     * @variation 1
     */
    Object.defineProperty(Test.prototype.serverStream = function serverStream(request, callback) {
        return this.rpcCall(serverStream, $root.Ping, $root.Pong, request, callback);
     ...
     * @variation 1
     */
    Object.defineProperty(Test.prototype.clientStream = function clientStream(request, callback) {
        return this.rpcCall(clientStream, $root.Ping, $root.Pong, request, callback);
     ...
     * @variation 1
     */
    Object.defineProperty(Test.prototype.bidiStream = function bidiStream(request, callback) {
        return this.rpcCall(bidiStream, $root.Ping, $root.Pong, request, callback);
