...
(function(global, factory) { /* global define, require, module */
    ...
    $root.Bytes = (function() {
        ...
        Bytes.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.byteString != null && Object.hasOwnProperty.call(message, "byteString"))
        ...
        Bytes.verify = function verify(message) {
            ...
            if (message.byteString != null && message.hasOwnProperty("byteString")) {
                var error = $root.BytesValue.verify(message.byteString);
                if (error)
    ...
    $root.Long = (function() {
        ...
        Long.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Long();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
