...
export const ServiceRequestBody = ($root.ServiceRequestBody = (() => {
  /**
  ...
  ServiceRequestBody.decode = function decode(reader, length) {
    ...
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ServiceRequestBody();
  ...
  ServiceRequestBody.fromObject = function fromObject(object) {
    ...
    let message = new $root.ServiceRequestBody();
    if (object.ping != null) {
...
export const Request = ($root.Request = (() => {
  ...
  Object.defineProperty(Request.prototype, 'body', {
    get: $util.oneOfGetter(
      ($oneOfFields = ['unary', 'stream', 'push', 'end', 'cancel', 'service']),
    ),
    set: $util.oneOfSetter($oneOfFields),
  });
  ...
  Request.verify = function verify(message) {
    ...
    if (message.service != null && message.hasOwnProperty('service')) {
      ...
      properties.body = 1;
      {
        let error = $root.ServiceRequestBody.verify(message.service);
