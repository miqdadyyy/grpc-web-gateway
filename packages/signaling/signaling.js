...
(function(global, factory) {
  ...
  $root.ServiceRequestBody = (function() {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ServiceRequestBody.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
    ...
    ServiceRequestBody.fromObject = function fromObject(object) {
      if (object instanceof $root.ServiceRequestBody) return object;
      var message = new $root.ServiceRequestBody();
      if (object.ping != null) {
  ...
  $root.Request = (function() {
    ...
    Request.encode = function encode(message, writer) {
      ...
      if (message.service != null && message.hasOwnProperty('service'))
        $root.ServiceRequestBody.encode(
          message.service,
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3:
            ...
            break;
          case 4:
            message.push = $root.PushRequestBody.decode(
              reader,
              reader.uint32(),
            );
            break;
          ...
          case 6:
            ...
            break;
          case 7:
            message.service = $root.ServiceRequestBody.decode(
              reader,
              reader.uint32(),
            );
            break;
    ...
    Request.toObject = function toObject(message, options) {
      ...
      if (message.stream != null && message.hasOwnProperty('stream')) {
        object.stream = $root.StreamRequestBody.toObject(
          message.stream,
          options,
        );
      ...
      if (message.cancel != null && message.hasOwnProperty('cancel')) {
        object.cancel = $root.CancelRequestBody.toObject(
          message.cancel,
          options,
        );
      ...
      if (message.service != null && message.hasOwnProperty('service')) {
        object.service = $root.ServiceRequestBody.toObject(
          message.service,
          options,
        );
        if (options.oneofs) object.body = 'service';
      }
  ...
  $root.UnaryRequestBody = (function() {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    UnaryRequestBody.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
      ...
      if (
        ...
        object.responseType =
          options.enums === String
            ? $root.ResponseType[message.responseType]
  ...
  $root.PushRequestBody = (function() {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    PushRequestBody.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
  ...
  $root.EndRequestBody = (function() {
    ...
    EndRequestBody.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length;
        var message = new $root.EndRequestBody();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          default:
  ...
  $root.Response = (function() {
    ...
    Object.defineProperty(Response.prototype, 'body', {
      get: $util.oneOfGetter(
        ($oneOfFields = ['unary', 'push', 'end', 'error']),
      ),
      set: $util.oneOfSetter($oneOfFields),
    });
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            ...
            break;
          case 3:
            message.push = $root.PushResponseBody.decode(
              reader,
              reader.uint32(),
            );
            break;
  ...
  $root.PushResponseBody = (function() {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    PushResponseBody.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
  ...
  $root.EndResponseBody = (function() {
     ...
     * @returns {$protobuf.Writer} Writer
     */
    EndResponseBody.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    EndResponseBody.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length;
        var message = new $root.EndResponseBody();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          default:
