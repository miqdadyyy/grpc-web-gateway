...
export const ServiceRequest = ($root.ServiceRequest = (() => {
  /**
   * Properties of a ServiceRequest.
   * @exports IServiceRequest
   * @interface IServiceRequest
   * @property {IPing|null} [ping] ServiceRequest ping
   * @property {IPong|null} [pong] ServiceRequest pong
   */
   ...
   * @instance
   */
  ServiceRequest.prototype.ping = null;
   ...
   * @instance
   */
  ServiceRequest.prototype.pong = null;
   ...
   * @instance
   */
  Object.defineProperty(ServiceRequest.prototype, 'body', {
   ...
   * @static
   * @param {IServiceRequest=} [properties] Properties to set
   * @returns {ServiceRequest} ServiceRequest instance
   */
   ...
   * @memberof ServiceRequest
   * @static
   * @param {IServiceRequest} message ServiceRequest message or plain object to encode
  ...
  /**
   * Encodes the specified ServiceRequest message, length delimited. Does not implicitly {@link ServiceRequest.verify|verify} messages.
  ...
  ServiceRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.ServiceRequest) return object;
    let message = new $root.ServiceRequest();
    if (object.ping != null) {
      if (typeof object.ping !== 'object')
        throw TypeError('.ServiceRequest.ping: object expected');
      message.ping = $root.Ping.fromObject(object.ping);
    }
    if (object.pong != null) {
      if (typeof object.pong !== 'object')
        throw TypeError('.ServiceRequest.pong: object expected');
   ...
   * @memberof ServiceRequest
   * @static
   * @param {ServiceRequest} message ServiceRequest
  ...
  ServiceRequest.toObject = function toObject(message, options) {
    ...
    if (message.ping != null && message.hasOwnProperty('ping')) {
      ...
      if (options.oneofs) object.body = 'ping';
    }
    if (message.pong != null && message.hasOwnProperty('pong')) {
      object.pong = $root.Pong.toObject(message.pong, options);
      if (options.oneofs) object.body = 'pong';
    }
    return object;
  };
...
export const Request = ($root.Request = (() => {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.unary = $root.UnaryRequestBody.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  Request.toObject = function toObject(message, options) {
    ...
    if (message.end != null && message.hasOwnProperty('end')) {
      ...
      if (options.oneofs) object.body = 'end';
    }
    if (message.cancel != null && message.hasOwnProperty('cancel')) {
      object.cancel = $root.CancelRequestBody.toObject(message.cancel, options);
      if (options.oneofs) object.body = 'cancel';
    }
    return object;
  };
...
export const UnaryRequestBody = ($root.UnaryRequestBody = (() => {
  ...
  UnaryRequestBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.UnaryRequestBody(),
      key;
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  UnaryRequestBody.fromObject = function fromObject(object) {
    if (object instanceof $root.UnaryRequestBody) return object;
...
export const PushRequestBody = ($root.PushRequestBody = (() => {
  ...
  PushRequestBody.fromObject = function fromObject(object) {
    if (object instanceof $root.PushRequestBody) return object;
...
export const EndRequestBody = ($root.EndRequestBody = (() => {
  ...
  EndRequestBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.EndRequestBody();
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  EndRequestBody.fromObject = function fromObject(object) {
    if (object instanceof $root.EndRequestBody) return object;
...
export const CancelRequestBody = ($root.CancelRequestBody = (() => {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  CancelRequestBody.encodeDelimited = function encodeDelimited(
    message,
    writer,
  ) {
    return this.encode(message, writer).ldelim();
  ...
  CancelRequestBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.CancelRequestBody();
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  CancelRequestBody.fromObject = function fromObject(object) {
    if (object instanceof $root.CancelRequestBody) return object;
...
export const Response = ($root.Response = (() => {
  ...
  Response.encode = function encode(message, writer) {
    ...
    if (message.id != null && message.hasOwnProperty('id'))
      writer.uint32(/* id 1, wireType 2 =*/ 10).string(message.id);
    if (message.unary != null && message.hasOwnProperty('unary'))
      $root.UnaryResponseBody.encode(
        message.unary,
        writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
      ).ldelim();
    if (message.push != null && message.hasOwnProperty('push'))
      $root.PushResponseBody.encode(
        message.push,
        writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
      ).ldelim();
    if (message.end != null && message.hasOwnProperty('end'))
      $root.EndResponseBody.encode(
        message.end,
        writer.uint32(/* id 4, wireType 2 =*/ 34).fork(),
      ).ldelim();
    if (message.error != null && message.hasOwnProperty('error'))
      $root.ErrorResponseBody.encode(
        message.error,
        writer.uint32(/* id 5, wireType 2 =*/ 42).fork(),
      ).ldelim();
    return writer;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.unary = $root.UnaryResponseBody.decode(
            reader,
            reader.uint32(),
          );
          break;
        ...
        case 4:
          ...
          break;
        case 5:
          message.error = $root.ErrorResponseBody.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  Response.toObject = function toObject(message, options) {
    ...
    if (message.error != null && message.hasOwnProperty('error')) {
      ...
      if (options.oneofs) object.body = 'error';
    }
    return object;
  };
...
export const UnaryResponseBody = ($root.UnaryResponseBody = (() => {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  UnaryResponseBody.encodeDelimited = function encodeDelimited(
    message,
    writer,
  ) {
    return this.encode(message, writer).ldelim();
  ...
  UnaryResponseBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.UnaryResponseBody();
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  UnaryResponseBody.fromObject = function fromObject(object) {
    if (object instanceof $root.UnaryResponseBody) return object;
...
export const PushResponseBody = ($root.PushResponseBody = (() => {
  ...
  PushResponseBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.PushResponseBody();
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  PushResponseBody.fromObject = function fromObject(object) {
    if (object instanceof $root.PushResponseBody) return object;
...
export const EndResponseBody = ($root.EndResponseBody = (() => {
  ...
  EndResponseBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.EndResponseBody();
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  EndResponseBody.fromObject = function fromObject(object) {
    if (object instanceof $root.EndResponseBody) return object;
...
export const ErrorResponseBody = ($root.ErrorResponseBody = (() => {
   ...
   * @returns {$protobuf.Writer} Writer
   */
  ErrorResponseBody.encodeDelimited = function encodeDelimited(
    message,
    writer,
  ) {
    return this.encode(message, writer).ldelim();
  ...
  ErrorResponseBody.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
    let end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ErrorResponseBody(),
      key;
    while (reader.pos < end) {
      let tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  ErrorResponseBody.fromObject = function fromObject(object) {
    if (object instanceof $root.ErrorResponseBody) return object;
